...
def is_sweltering():
    ...
    Temperature = float(input("Please enter the current temperature in Farenheit: "))
    if Temperature > 90:
        return True
    else:
        return False
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    Humid = input("Whether it is currently humid? ")
    if Humid == "yes":
        return True
    if Humid == "no":
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    response = input("What's the weather forecast today? ").lower()
    potential_weathers={"rain", "snow", "sleet"}

    return response in potential_weathers
